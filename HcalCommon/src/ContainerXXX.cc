...
namespace hcaldqm
{
	...
	/* virtual */ void ContainerXXX::set(HcalDetId const& did, STDTYPE x)
	{
	...
	/* virtual */ STDTYPE& ContainerXXX::get(HcalDetiD const& did)
	{
		return _cmap[_hashmap.getHash(did)];
	}
	
	/* virtual */ STDTYPE& ContainerXXX::get(HcalElectronicsiD const& eid)
	{
		return _cmap[_hashmap.getHash(eid)];
	}

	/* virtual */ STDTYPE& ContainerXXX::get(HcalTrigTowerDetId const& tid)
	{
